...
private val horizontalWhitespacePattern = Regex("\\h")
private val verticalWhitespacePattern = Regex("\\v")
private class Range(var start: Int, var endExclusive: Int) {
 ...
 */
private class CharPointer(val original: CharSequence) : CharSequence {
	var index: Int? = null
		private set
 ...
 */
fun wrapText(input: String, width: Int, locale: Locale): String {
